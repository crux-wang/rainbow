...
//
//
//    public static List<ren.crux.rainbow.core.model.RequestMapping> getAllRequestMapping(MethodDoc methodDoc) {
...
//                return new ren.crux.rainbow.core.model.RequestMapping(method, path);
//            } else {
//                return null;
//            }
