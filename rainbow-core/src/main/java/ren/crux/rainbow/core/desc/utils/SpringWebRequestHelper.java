...
//
//
//    public static List<ren.crux.rainbow.core.desc.model.RequestMapping> getAllRequestMapping(MethodDoc methodDoc) {
...
//                return new ren.crux.rainbow.core.desc.model.RequestMapping(method, path);
//            } else {
//                return null;
//            }
